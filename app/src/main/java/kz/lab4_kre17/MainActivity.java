...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.z_vspomogatelnoe);
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.POSITION0101);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.POSITION0101);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.POSITION0101) {
            webView.loadUrl(resourceDir + "01/POSITION0101/20 лучших электрических плит — Рейтинг 2022 года (Топ 20).html");
        } else if (id == R.id.POSITION0102) {
            webView.loadUrl(resourceDir + "01/POSITION0102/Какие бывают виды электрических плит по типу конфорок, покрытий.html");
        } else if (id == R.id.POSITION0103) {
            webView.loadUrl(resourceDir + "01/POSITION0103/Рейтинг лучших электрических плит 2021 топ 10 - ПрофОбзор - Дзен.html");
        } else if (id == R.id.POSITION0104) {
            webView.loadUrl(resourceDir + "01/POSITION0104/Электрическая плита — Википедия.html");
        } else if (id == R.id.POSITION0105) {
            webView.loadUrl(resourceDir + "01/POSITION0105/Электрическая плита (61 фото)- как выбрать электроплиту с духовкой и без нее для кухни- Виды и рейтинг лучших кухонных бытовых плит.html");
        } else if (id == R.id.sulpak) {
            webView.loadUrl(resourceDir + "02/Газовые и электрические плиты в Павлодаре - Купить по выгодной цене в Павлодаре - интернет-магазин Sulpak.html");
        } else if (id == R.id.technodom) {
            webView.loadUrl(resourceDir + "02/Плиты электрические - купить в Павлодаре, по недорогой цене в Казахстане _ интернет магазин Технодом.html");
        } else if (id == R.id.mechta) {
            webView.loadUrl(resourceDir + "02/Электрические плиты купить по выгодной цене _ Mechta.kz (10_22_2022 11_16_49 AM).html");
            ...
            if (id == R.id.itemNapisatPismo) { // Переход на отправку письма автору
